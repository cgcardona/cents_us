  ...
  paintPixels : ->
    ...
    _.each(@.populationTotals, (element, index, list) ->
      ...
      if element.type isnt 'Total'
        ...
        $(containerDiv).append($('<li></li>').text('Total below poverty: ' + parseInt(element.totalBelow, 10)))
        $(containerDiv).append($('<li></li>').text('Below 5: ' + parseInt(element.below5, 10)))
        $(containerDiv).append($('<li></li>').text('At 5: ' + parseInt(element.at5, 10)))
        $(containerDiv).append($('<li></li>').text('6 to 11: ' + parseInt(element.sixTo11, 10)))
        $(containerDiv).append($('<li></li>').text('12 to 17: ' + parseInt(element.twelveTo17, 10)))
        $(containerDiv).append($('<li></li>').text('18 to 64: ' + parseInt(element.eighteenTo64, 10)))
        $(containerDiv).append($('<li></li>').text('65 to 74: ' + parseInt(element.sixtyFiveTo74, 10)))
        $(containerDiv).append($('<li></li>').text('75 and above: ' + parseInt(element.seventyFiveAndAbove, 10)))
